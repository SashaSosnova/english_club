        ...
        lessons: lessons(1, 2, [
          {
            ...
            vocab: ['apple', 'key', 'bus', 'man', 'woman', 'shoes'],
          },
          {
            title: 'There is / there are',
            titleRu: 'There is / there are',
            grammar: 'There is / There are; questions',
            vocab: ['room', 'kitchen', 'sofa', 'fridge', 'lamp'],
          },
          {
            title: 'have got',
            titleRu: 'have got',
            grammar: "have got / has got; Have you got…?",
            vocab: ['car', 'bike', 'laptop', 'pet', 'job'],
          },
          {
            title: 'Food & café',
            titleRu: 'Еда и кафе',
            grammar: 'review a/an + café phrases',
            vocab: ['menu', 'order', 'tea', 'salad', 'bill'],
          },
        ]),
      },
      {
