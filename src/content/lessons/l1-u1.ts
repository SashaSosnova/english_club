    ...
    exercises: [
      {
        ...
        points: [
          'I am (I\'m) — я … (имя, откуда, профессия)',
          'you/we/they are (you\'re…) — ты/вы/мы/они',
    ...
    exercises: [
      {
        type: 'explain',
        id: 'e1',
        title: 'Числа, время и дни',
        points: [
          'Числа 1–20: one, two, three… twelve, thirteen… twenty',
          "What's the time? — It's 7 o'clock. / It's half past 7.",
          'at + время: at 7, at half past 7',
          'on + день: on Monday, on Saturday',
          'at the weekend (BrE) / on the weekend (AmE) — в курсе чаще BrE',
          'How much is it? — Сколько это стоит?',
        ],
        examples: [
          "It's 9 o'clock in the morning.",
          'See you at 6 on Saturday.',
      ...
      },
      {
        type: 'drill',
        id: 'e7',
        prompt: '___ much is it?',
        promptRu: 'Спросить цену',
      ...
      },
      {
        type: 'builder',
        id: 'e8',
        prompt: 'Соберите фразу про время',
        tokens: ["It's", 'ten', "o'clock", '.'],
      ...
      },
      {
        ...
        cards: [
          ...
          },
          {
            id: 'c5',
            term: 'weekend',
            translation: 'выходные (BrE: at the weekend)',
          ...
          },
          {
            ...
            example: 'How much is it? — Five pounds.',
          },
          {
            id: 'c7',
            term: 'today',
      ...
      },
      {
        ...
        lines: [
          ...
          },
          {
            id: 'd5',
            speaker: 'Sam',
            text: 'How much is a coffee here?',
          },
          {
            id: 'd6',
            speaker: 'You',
            choices: [
              { text: 'It is three euros.', correct: true },
              { text: 'It are three euros.', correct: false },
            ],
          },
        ],
      },
