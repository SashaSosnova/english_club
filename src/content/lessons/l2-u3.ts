    ...
    exercises: [
      {
        ...
        points: [
          ...
          'unless = if not / если не: I will stay unless it rains.',
    ...
    exercises: [
      {
        ...
        points: [
          ...
          'been to = был там и вернулся: I have been to Paris twice.',
          'gone to = уехал туда и ещё там / в пути: She has gone to Paris — she is still there.',
        ],
        examples: [
          'Have you ever tried sushi?',
          'I have been to Japan, but I am home now.',
          'Sam has gone to the shop. He is not here.',
        ],
      },
      {
        type: 'drill',
        id: 'e2',
        prompt: 'Have you ever ___ to Japan? (visited and came back)',
      ...
      },
      {
        type: 'drill',
        id: 'e3',
        prompt: 'Where is Mum? She has ___ to the shop — she is still there.',
        options: ['gone', 'been', 'went'],
        answer: 'gone',
      },
      {
        type: 'drill',
        id: 'e4',
        prompt: 'I have ___ to Rome twice. I am not there now.',
      ...
      },
      {
        type: 'cloze',
        id: 'e7',
        text: 'A: Have you ever ___ to Paris? B: Yes. But Tom is away — he has ___ to Paris for work this week.',
        gaps: [
          { id: 'g1', answer: 'been', options: ['been', 'gone', 'went'] },
          { id: 'g2', answer: 'gone', options: ['gone', 'been', 'went'] },
        ],
      },
      {
        type: 'builder',
      ...
      },
      {
        ...
        cards: [
          ...
          },
          {
            id: 'a2c63',
            term: 'been to',
            translation: 'был в (и вернулся)',
            example: 'I have been to Rome twice.',
          },
          {
            id: 'a2c64',
            term: 'gone to',
            translation: 'уехал в (ещё там)',
      ...
      },
      {
        ...
        promptRu:
          '6 вопросов Have you ever…? и коротких ответов (Yes, I have / No, never). Добавьте 1 пару been/gone.',
        hints: [
